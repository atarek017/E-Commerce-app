...
class KeellsDeals extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: ListView.builder(
        itemCount: _productProvider.keellsProducts.length,
        shrinkWrap: true,
        ...
        itemBuilder: (BuildContext context, int index) {
          return InkWell(
            child: Padding(
              ...
              child: ProductFrame(_productProvider.keellsProducts[index]),
            ),
            onTap: () {
              _productProvider.selectedProduct =
                  _productProvider.keellsProducts[index];
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) =>
                          SelectedProductPage("Keells Deal")));
            },
          );
        },
      ),
